...
- [ ] **[P1-1]** สร้าง `src/data/companionRegistry.ts` — Pluggable Companion Registry
...
- [ ] **[P1-2]** อัปเดต `src/types/companion.ts` — Extended Type Contracts
...
- [ ] **[P1-3]** อัปเดต `src/stores/companionStore.ts` — Active Companion State
...
- [ ] **[P2-1]** สร้าง `src/assets/sprites/neko-sprites.svg` (256x320 px)
...
- [ ] **[P2-2]** สร้าง `src/assets/sprites/prop-fish.svg` (64x64 px, 2-frame bob)
  - กองปลาทูย่าง 3 ตัวซ้อนกัน ดุ๊กดิ๊กตามจังหวะท่าทางหลัก

- [ ] **[P2-3]** สร้าง `src/assets/sprites/shiba-sprites.svg` (256x320 px)
...
- [ ] **[P2-4]** สร้าง `src/assets/sprites/prop-croissant.svg` (64x64 px, 2-frame bob)
  - คอนโดครัวซองต์เนยสด 4 ชิ้นซ้อนกันสูงโยกเยก

- [ ] **[P2-5]** สร้าง `src/assets/sprites/capybara-sprites.svg` (256x320 px)
...
- [ ] **[P2-6]** สร้าง `src/assets/sprites/prop-yuzu.svg` (64x64 px, 2-frame bob)

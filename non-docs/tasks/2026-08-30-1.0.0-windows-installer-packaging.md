...
- **Status**: 🟡 In Progress (Phase 1 Complete - 25%)
...
- [ ] **Step 2.1 Application Icon Assets (`src-tauri/icons/`)**:
  - สร้างชุด Icon ความละเอียดสูงสำหรับ Desktop Mascot และ Windows Installer:
    - `32x32.png`, `128x128.png`, `128x128@2x.png`, `icon.ico`, `icon.png`
- [ ] **Step 2.2 Tauri Configuration Tuning (`src-tauri/tauri.conf.json`)**:
  - กำหนด Bundle Targets สำหรับ Windows: `["nsis", "msi"]`
  - ตั้งค่า Application Metadata, Publisher, Product Name และ Icon Mapping ให้สมบูรณ์
